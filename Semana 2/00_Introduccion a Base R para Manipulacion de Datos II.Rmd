...
```{r}
# Creamos un nuevo dataframe con informacion nueva de letras, en este ejemplo un rankeo
nueva_info_letras <- data.frame(rankeo= seq(1, nrow(letras_bc), by=1)) #Se utiliza la funcion nrows para obtener el numero de filas 
...
##En este caso hacemos un left join porque nos interesa toda la informacion que esta en el dataframe x (letras_bc), pero no toda la informacion que esta en el dataframe y (subasta_desierta)
